...
<head>
    ...
    <script>
        ...
        KindEditor.ready(function (K) {
            ...
            prettyPrint();
            <%--editor1.html(${information.iBody});--%>
        });
    </script>
</head>
<body>
...
<div class="row" style="width: 1400px">
    ...
    <div class="col-xs-10 col-md-10">
        <form class="form-signin" id="addInformation" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    <input style="width: 500px;height: 40px" id="iTitle" type="text" name="iTitle"
                           value="${information.iTitle}" class="form-control" disabled placeholder="标题" required
                           autofocus>
                </div>
                <%--</td>--%>
                <%--<td>时间</td>--%>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input style="width: 500px;height: 40px" id="iDate" type="text" name="iDate"
                           value="${information.iDate}" class="form-control" placeholder="时间" disabled required
                           autofocus>
                </div>
            </div>
            <%--</td>--%>
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    <select style="width: 300px" id="iCategory" name="iCategory" class="form-control">
                        <option value="${information.iCategory}">${information.iCategory}</option>
                    </select>
                </div>
                <%--<script>--%>
            ...
            <textarea id="editor_id" name="iBody" cols="100" rows="8"
                      style="width:1000px;height:700px;float: left;display: none"
                      disabled>${information.iBody}<%=htmlspecialchars(htmlData)%></textarea>
            <%--<input type="submit" name="button" value="提交内容" /> (提交快捷键: Ctrl + Enter)--%>
            <div class="row">
                <label style="line-height: 40px;width: 70px" class="col-sm-1">附件:</label>
                <div class="col-sm-11">
                    <%--<input style="width: 300px;height: 40px" id="fileUpload" type="file" name="fileUpload" value="${information.iadjunctName}" class="form-control" placeholder="附件" autofocus>--%>
        ...
        <%--document.getElementById("addInformation").submit();--%>
        <%--}--%>
        <%--</script>--%>
        <%--<input type="submit" style="height: 40px;width: 100px" class="btn btn-info" onclick="return addInformation()" value="添加资讯">--%>
