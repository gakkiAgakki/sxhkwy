...
<div class="row" style="width: 1400px">
    ...
    <div class="col-xs-10 col-md-10">
        <form class="form-signin" id="addInformation" action="/background/addInformation.action" method="post"
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    <input style="width: 500px;height: 40px" id="iTitle" type="text" name="iTitle" class="form-control"
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input style="width: 500px;height: 40px" id="iDate" type="text" name="iDate" value="<%=date%>"
                           class="form-control" placeholder="时间" required autofocus>
                </div>
            </div>
            <%--</td>--%>
            <%--</tr>--%>
            ...
            <textarea id="editor_id" name="iBody" cols="100" rows="8"
                      style="width:1000px;height:700px;float: left;display: none"><%=htmlspecialchars(htmlData)%></textarea>
            ...
            <%--<td>--%>
            <%--<div class="row">--%>
            <%--<label for="file" style="line-height: 40px;width: 70px" class="col-sm-1">图片:</label>--%>
            <%--<div class="col-sm-11">--%>
            <%--<input style="width: 300px;height: 40px" id="file" type="file" name="uploadFilePic" value="上传图片" class="form-control" placeholder="附件" autofocus>--%>
            <%--</div>--%>
            <%--</div>--%>
            <%--</td>--%>
            <%--</tr>--%>
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    <input style="width: 300px;height: 40px" id="fileUpload" type="file" name="fileUpload" value="上传附件"
                           class="form-control" placeholder="附件" autofocus>
                </div>
            </div>
            <%--</td>--%>
            <%--</tr>--%>
        ...
        <input type="submit" style="height: 40px;width: 100px" class="btn btn-info" onclick="return addInformation()"
               value="添加资讯">
